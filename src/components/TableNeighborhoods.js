...
const TableNeighborhoods = () => {
  ...
  const { data: neighborhoodsPaginated, error, mutate } = useSWR(
    `/neighborhoods?page=${page + 1}`,
    fetcher
  );
  const { data: neighborhoodsAllData, error: error2, mutate: mutate2 } = useSWR(
    `/neighborhoods/all`,
    fetcher
  );
  ...
  return (
    <>
      <h1 style={styles.title}>
        Gestión y asignación de barrios y frecuencias
      </h1>
      ...
      <div>
                  ...
                  <TableBody>
                    {neighborhoodsPaginated.data.map((neighborhood) => (
                      <StyledTableRow key={neighborhood.id}>
                        ...
                        <StyledTableCell align="center">
                          {neighborhood.truck
                            ? neighborhood.truck.license_plate
                            : "No tiene camión"}
                        </StyledTableCell>
                        <StyledTableCell align="left">
                          {neighborhood.complaint.data.length > 0 ? (
                            <IconButton
                              ...
                              component="span"
                              onClick={() =>
                                handleOpenEditNeigbhorhood(neighborhood.id)
                              }
                            >
                              <BorderColorIcon />
                            </IconButton>
                            ...
                            <>
                              ...
                              <IconButton
                                ...
                                component="span"
                                onClick={() =>
                                  handleOpenDeleteNeigbhorhood(neighborhood.id)
                                }
                              >
                                <DeleteIcon />
                              </IconButton>
        ...
        <div>
          <Dialog
            onClose={handleOpenNewNeigbhorhood}
            open={openAddNeighborhood}
          >
          ...
          <Dialog
            onClose={handleCloseEditNeigbhorhood}
            open={openEditNeighborhood}
          >
            <DialogContent dividers>
              <EditNeighborhood
                id={neighborhoodId}
          ...
          <Dialog
            onClose={handleCloseDeleteNeigbhorhood}
            open={openDeleteNeighborhood}
          >
            <DialogContent dividers>
              <DeleteNeighborhood
                id={neighborhoodId}
