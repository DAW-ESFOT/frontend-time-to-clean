    ...
    <div style={styles.Container}>
      <Container fixed>
        ...
        <Typography variant="body1" gutterBottom>
          El presente Política de Privacidad establece los términos en que Time
          To Clean usa y protege la información que es proporcionada por sus
          usuarios al momento de utilizar su sitio web. Esta compañía está
          comprometida con la seguridad de los datos de sus usuarios. Sin
        ...
        <Typography variant="body1" gutterBottom>
          La plataforma emplea la información con el fin de proporcionar una
          buena gestión laboral. Time To Clean está altamente comprometido para
        ...
        <Typography variant="body1" gutterBottom>
          ...
          cookies. Usted puede eliminar las cookies en cualquier momento desde
          ...
          proporcione directamente. Puede cambiar la configuración de su
        ...
        <Typography variant="body1" gutterBottom>
          ...
          requerido por un juez con un orden judicial. Time To Clean se reserva
          el derecho de cambiar los términos de la presente Política de
