...
const styles = {
  container: {
    background:
      "linear-gradient(0deg, rgba(168,304,216,1) 0%, rgba(96,149,176,1) 100%)",
    padding: "35px",
  },
  Paper: {
          ...
          <div>
            <Box display="flex" justifyContent="center" m={1} p={1}>
              <h1 style={styles.title}>
                Encuentra la información sobre tu sector de manera fácil y
                rápida
              </h1>
            </Box>
          </div>
              ...
              <Grid item xs={12} justify={"center"}>
                ...
                >
                  ...
                  {data.data.map((neighborhood, index) => {
                    return <option value={index}>{neighborhood.name}</option>;
                  })}
                </TextField>
              </Grid>
              <Grid item xs={12} justify={"center"}>
                          ...
                          secondary={
                            <React.Fragment>
                              <Typography
                                ...
                                color="textPrimary"
                              >
                                {neighborhoodID.start_time} -{" "}
                                {neighborhoodID.end_time}
                              </Typography>
                            </React.Fragment>
                          }
                        />
