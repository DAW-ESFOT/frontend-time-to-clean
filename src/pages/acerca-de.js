...
const AcercaDe = () => {
    return (
        <div style={styles.Container}>
            <Typography variant="h4" gutterBottom style={styles.Title}>¿Quienes somos?</Typography>
                ...
                <Grid item xs={12} sm={6}>
                    <Paper style={styles.Paper} elevation={3}>
                        <Typography variant="body1" gutterBottom>
                            Time2Clean nace como una idea de proyecto de Desarrollo de Aplicaciones Web en el año 2020,
                            ...
                            manera intutitva para que la gestion y comunicacion entre personal del servicio y
